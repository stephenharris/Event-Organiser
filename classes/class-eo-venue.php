...
class EO_Venue{
	...
	function country_select(){
		...
		<select name="eo_venue[Country]" id="country-selector" class="eo_addressInput">
			...
			<?php foreach (self::$countries as $country => $alternate): ?>
