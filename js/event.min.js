jQuery(document).ready(function(b){function C(){b("#eo_occurrence_includes").val(w.join(",\r\n"));b("#eo_occurrence_excludes").val(x.join(",\r\n"))}function u(){var g=!b("#HWSEvent_rec").prop("checked");b(".reoccurence .event-date :input").attr("disabled",g);b(".reoccurence .event-date :input").toggleClass("ui-state-disabled",g);g=!b("#eo_allday:checkbox").attr("checked");b(".eo_time").attr("disabled",!g);b(".eo_time").toggleClass("ui-state-disabled",!g);switch(b("#HWSEventInput_Req").val()){case "once":case "custom":b("#HWSEvent_freq").val("1");
b(".reocurrence_row").hide();b("#dayofweekrepeat").show();b("#dayofmonthrepeat").show();b(".reocurrence_row").attr("disabled",true);break;case "weekly":b(".reocurrence_row :input").attr("disabled",false);b("#HWSEvent_freq").val()>1?b("#recpan").text(o.weeks):b("#recpan").text(o.week);b(".reocurrence_row").fadeIn(700);b("#dayofweekrepeat").fadeIn(700);b("#dayofweekrepeat :input").attr("disabled",false);b("#dayofweekrepeat").buttonset("enable");b("#dayofmonthrepeat").hide();b("#dayofmonthrepeat :radio").attr("disabled",
true);break;case "monthly":b(".reocurrence_row :input").attr("disabled",false);b("#HWSEvent_freq").val()>1?b("#recpan").text(o.months):b("#recpan").text(o.month);b(".reocurrence_row").fadeIn(700);b("#dayofmonthrepeat").fadeIn(700);b("#dayofmonthrepeat :input").attr("disabled",false);b("#dayofweekrepeat").hide();b("#dayofweekrepeat :input").attr("disabled",true);break;case "daily":b(".reocurrence_row :input").attr("disabled",false);b(".reocurrence_row").fadeIn(700);b("#HWSEvent_freq").val()>1?b("#recpan").text(o.days):
b("#recpan").text(o.day);b("#dayofweekrepeat").hide();b("#dayofweekrepeat :input").attr("disabled",true);b("#dayofmonthrepeat").hide();b("#dayofmonthrepeat :radio").attr("disabled",true);break;case "yearly":b(".reocurrence_row :input").attr("disabled",false);b(".reocurrence_row").fadeIn(700);b("#HWSEvent_freq").val()>1?b("#recpan").text(o.years):b("#recpan").text(o.year);b("#dayofweekrepeat").hide();b("#dayofweekrepeat :input").attr("disabled",true);b("#dayofmonthrepeat").hide();b("#dayofmonthrepeat :radio").attr("disabled",
true);break}b("#venue_select").val()===null&&b("tr.venue_row").hide();p()}function p(){if(b("#HWSEventInput_Req").val()=="once")b("#event_summary").html("This event will be a one-time event");else{var g=b("#from_date").datepicker("getDate"),j=EO_Ajax_Event.locale.weekDay,v=new Array("SU","MO","TU","WE","TH","FR","SA"),n={monthNamesShort:EO_Ajax_Event.locale.monthAbbrev,dayNamesMin:EO_Ajax_Event.locale.dayAbbrev,monthNames:EO_Ajax_Event.locale.monthNames};b("#HWSEventInput_Req :selected").text();var h=
parseInt(b("#HWSEvent_freq").val()),m=o.summary+" ";switch(b("#HWSEventInput_Req").val()){case "custom":case "daily":m+=h>1?sprintf(o.dayPlural,h):o.daySingle;break;case "weekly":m+=h>1?sprintf(o.weekPlural,h):o.weekSingle;h=b("#dayofweekrepeat :checkbox:checked");if(h.length==0){h=g.getDay();b("#dayofweekrepeat :checkbox[value='"+v[h]+"']").attr("checked",true)}h=b("#dayofweekrepeat :checkbox:checked");h.each(function(q){if(q==0)m=m+" "+j[v.indexOf(b(this).val())];if(q>0)m=m+", "+j[v.indexOf(b(this).val())]});
break;case "monthly":m+=h>1?sprintf(o.monthPlural,h):o.monthSingle;if(b("#dayofmonthrepeat :radio:checked").val()=="BYMONTHDAY=")m=m+" "+g.getDate()+a(g);else{h=g.getDay()%7;g=parseInt(Math.floor((g.getDate()-1)/7));m=m+" "+o.occurrence[g]+" "+j[h]}break;case "yearly":m+=h>1?sprintf(o.yearPlural,h):o.yearSingle;m=m+" "+b.datepicker.formatDate("MM d",g,n)+a(g);break}g=b("#recend").datepicker("getDate");if(g!=null)m=m+" "+o.until+" "+b.datepicker.formatDate("MM d'"+a(g)+"' yy",g,n);b("#event_summary").html(m)}}
function a(g){return["th","st","nd","rd"][3<g.getDate()&&g.getDate()<20?0:Math.min(g.getDate()%10,4)%4]}function c(){x=[];w=[];C();f(eo_viewing_month[0],eo_viewing_month[1],{});D.datepicker("refresh")}function e(g){g=b.datepicker.formatDate("yy-mm-dd",g);if(d(g)[0])return[true,"ui-state-active",""];return[true,"ui-state-disabled",""]}function d(g){if(b.inArray(g,s)>-1){g=b.inArray(g,x);return g>-1?[false,g]:[true,-1]}else{g=b.inArray(g,w);return g>-1?[true,g]:[false,-1]}}function f(g,j){s=[];eo_viewing_month=
[g,j];var v=b("#HWSEventInput_Req").val(),n=parseInt(b("#HWSEvent_freq").val()),h=b("#from_date").datepicker("getDate"),m=b("#recend").datepicker("getDate");j-=1;var q=new Date(g,j,1),y=new Date(new Date(g,j+1,1)-1);if(!(m<q||h>y)){switch(v){case "once":case "custom":g=b.datepicker.formatDate("yy-mm-dd",h);s.push(g);return;case "daily":if(h<q){var F=Math.abs((q-h)/864E5)-1;F%=n}else F=parseInt(h.getDate());j=n;var H=[],E=new Date(q);E.setDate(q.getDate()+(F-1));H.push(E);break;case "weekly":var r=
q.getDay();r=b("#dayofweekrepeat :checkbox:checked");var K=new Array("SU","MO","TU","WE","TH","FR","SA");H=[];r.each(function(J){J=K.indexOf(b(this).val());E=new Date(h);E.setDate(h.getDate()+(J-h.getDay()+7)%7);if(E<q){F=Math.abs((q-h)/864E5);F-=F%(n*7);E.setDate(E.getDate()+F)}H.push(E)});j=7*n;break;case "monthly":if(((g-h.getFullYear())*12+j-(h.getMonth()+1))%n!=0)return;if(b('input[name="eo_input[schedule_meta]"]:checked').val()=="BYMONTHDAY="){var G=h.getDate();y=y.getDate();if(G<=y)r=new Date(g,
j,G)}else{g=Math.ceil(h.getDate()/7);G=h.getDay();if(g>=5){r=y.getDay();y=y.getDate()+(G-r-7)%7}else{r=q.getDay();y=(G-r+7)%7+(g-1)*7+1}r=new Date(q);r.setDate(y)}if(r<=m){g=b.datepicker.formatDate("yy-mm-dd",r);s.push(g)}return;case "yearly":if((g-h.getFullYear())%n!=0)return;y=new Date(g,h.getMonth(),h.getDate());if(j==h.getMonth()&&y.getMonth()==h.getMonth()){r=new Date(h);r.setYear(g);if(r<=m){g=b.datepicker.formatDate("yy-mm-dd",r);s.push(g)}}return;default:return}for(G in H)for(r=new Date(H[G]);r<=
y&&r<=m;){g=b.datepicker.formatDate("yy-mm-dd",r);s.push(g);r.setDate(r.getDate()+j)}}}function i(g){var j=d(g);if(j[0]){j=j[1];j>-1?k(j):t(g)}else{j=j[1];j>-1?z(j):l(g)}C()}function l(g){b.inArray(g,w)<0&&w.push(g)}function k(g){w.splice(g,1)}function t(g){b.inArray(g,x)<0&&x.push(g)}function z(g){x.splice(g,1)}if(!Array.prototype.indexOf)Array.prototype.indexOf=function(g,j){var v=this.length;j=Number(j)||0;j=j<0?Math.ceil(j):Math.floor(j);if(j<0)j+=v;for(;j<v;j++)if(j in this&&this[j]===g)return j;
return-1};var s=[],w,x,B;if(b("#eo_occurrence_includes").length>0){w=b("#eo_occurrence_includes").val().split(",");x=b("#eo_occurrence_excludes").val().split(",")}b(document).ready(function(){b.widget("ui.combobox",{_create:function(){var g,j=this.element.hide(),v=j.children(":selected");v=v.val()?v.text():"";j=b("<span>").addClass("ui-combobox eo-venue-input").insertAfter(j);g=b("<input>").appendTo(j).val(v).addClass("ui-combobox-input").autocomplete({delay:0,minLength:0,source:function(n,h){b.getJSON(EO_Ajax_Event.ajaxurl+
"?callback=?&action=eo-search-venue",n,function(m){m=b.map(m,function(q){q.label=q.name;return q});h(m)})},select:function(n,h){if(b("tr.venue_row").length>0){h.item.term_id==0?b("tr.venue_row").hide():b("tr.venue_row").show();b("#eventorganiser_event_detail tr.eo-add-new-venue").hide();eo_initialize_map(h.item.venue_lat,h.item.venue_lng);b("#eo_venue_Lat").val(h.item.venue_lat);b("#eo_venue_Lng").val(h.item.venue_lng)}b("#venue_select").removeAttr("selected");b("#venue_select").val(h.item.term_id)}}).addClass("ui-widget-content ui-corner-left");
g.data("autocomplete")._renderItem=function(n,h){if(h.term_id==0)return b("<li></li>").data("item.autocomplete",h).append("<a>"+h.label+"</a>").appendTo(n);var m=[h.venue_address,h.venue_postal,h.venue_country];m=b.grep(m,function(q){return q});return b("<li></li>").data("item.autocomplete",h).append("<a>"+h.label+"</br> <span style='font-size: 0.8em'><em>"+m.join(", ")+"</span></em></a>").appendTo(n)};j=b("<span>").addClass("eo-venue-combobox-buttons").appendTo(j);b("<a style='vertical-align: top;margin: 0px -1px;padding: 0px;height: 21px;'>").attr("title",
"Show All Items").appendTo(j).button({icons:{primary:"ui-icon-triangle-1-s"},text:false}).removeClass("ui-corner-all").addClass("ui-corner-right ui-combobox-toggle ui-combobox-button").click(function(){if(g.autocomplete("widget").is(":visible"))g.autocomplete("close");else{b(this).blur();g.autocomplete("search","");g.focus()}});"event"==pagenow&&b("<a style='vertical-align: top;margin: 0px -1px;padding: 0px;height: 21px;'>").attr("title","Create New Venue").appendTo(j).button({icons:{primary:"ui-icon-plus"},
text:false}).removeClass("ui-corner-all").addClass("ui-corner-right add-new-venue ui-combobox-button").click(function(){b("#eventorganiser_event_detail tr.eo-add-new-venue").show();b("tr.venue_row").show();B={id:b("#venue_select").val(),label:b(".eo-venue-input input").val(),lat:b("#eo_venue_Lat").val(),lng:b("#eo_venue_Lng").val()};b("#venue_select").removeAttr("selected").val(0);b(".eo-venue-combobox-select").hide();b(".eo-venue-input input").val("");eo_initialize_map(0,0);var n=EO_Ajax_Event.location;
if(n){n=n.split("/");n=n[n.length-1];eventorganiser_code_address(n)}else map.setZoom(1);b(this).blur()})}});b("#venue_select").combobox()});b(".eo-add-new-venue-cancel").click(function(g){g.preventDefault();b(".eo-venue-combobox-select").show();b(".eo-add-new-venue input").val("");eo_initialize_map(B.lat,B.lng);b("#venue_select").val(B.id);b(".eo-venue-input input").val(B.label);b("#eventorganiser_event_detail tr.eo-add-new-venue").hide()});var o=EO_Ajax_Event.locale;if(b("#eventorganiser_detail #from_date, #eventorganiser_detail #to_date").length>
0){var I=b("#eventorganiser_detail #from_date, #eventorganiser_detail #to_date").datepicker({dateFormat:EO_Ajax_Event.format,changeMonth:true,changeYear:true,monthNamesShort:EO_Ajax_Event.locale.monthAbbrev,dayNamesMin:EO_Ajax_Event.locale.dayAbbrev,firstDay:parseInt(EO_Ajax_Event.startday),buttonImage:"images/ui-icon-calendar.png",onSelect:function(g){var j=this.id=="from_date"?"minDate":"maxDate",v=b(this).data("datepicker");g=b.datepicker.parseDate(v.settings.dateFormat||b.datepicker._defaults.dateFormat,
g,v.settings);I.not(this).datepicker("option",j,g);this.id=="from_date"&&b("#recend").datepicker("option","minDate",g);c();u()}});b("#recend").datepicker({dateFormat:EO_Ajax_Event.format,monthNamesShort:EO_Ajax_Event.locale.monthAbbrev,dayNamesMin:EO_Ajax_Event.locale.dayAbbrev,changeMonth:true,changeYear:true,firstDay:parseInt(EO_Ajax_Event.startday)});b("#HWSEvent_time, #HWSEvent_time2").timepicker({showPeriodLabels:false,hourText:EO_Ajax_Event.locale.hour,minuteText:EO_Ajax_Event.locale.minute});
b("#HWSEvent_rec").click(function(){u()});b(".reoccurence .event-date :input, .onetime .event-date :input").not(".eo_time").change(function(){u();b(this).attr("id")!="eo_allday"&&c()});u();var A=!b(this).prop("checked");b(".reoccurence .event-date :input").attr("disabled",A);b(".reoccurence .event-date :input").toggleClass("ui-state-disabled",A)}b(".eo_occurrence_toogle").click(function(g){g.preventDefault();g.stopPropagation();D.toggle()});A=new Date;f(A.getFullYear(),A.getMonth()+1,{});var D=b("#eo_occurrence_datepicker");
D.length>0&&D.datepicker({dateFormat:"yy-mm-dd",onSelect:i,beforeShowDay:e,onChangeMonthYear:f,changeMonth:true,changeYear:true,monthNamesShort:EO_Ajax_Event.locale.monthAbbrev,dayNamesMin:EO_Ajax_Event.locale.dayAbbrev,firstDay:parseInt(EO_Ajax_Event.startday)}).hide();b("html").click(function(){D.hide()});D.find(".ui-datepicker-inline").click(function(g){if(!g)g=window.event;g.cancelBubble=true;g.stopPropagation&&g.stopPropagation()})});
var sprintf=function(){function b(p){return Object.prototype.toString.call(p).slice(8,-1).toLowerCase()}function C(p,a){for(var c=[];a>0;c[--a]=p);return c.join("")}var u=function(){u.cache.hasOwnProperty(arguments[0])||(u.cache[arguments[0]]=u.parse(arguments[0]));return u.format.call(null,u.cache[arguments[0]],arguments)};u.format=function(p,a){var c=1,e=p.length,d="",f=[],i,l,k,t;for(i=0;i<e;i++){d=b(p[i]);if(d==="string")f.push(p[i]);else if(d==="array"){k=p[i];if(k[2]){d=a[c];for(l=0;l<k[2].length;l++){if(!d.hasOwnProperty(k[2][l]))throw sprintf('[sprintf] property "%s" does not exist',
...
break;case "x":d=d.toString(16);break;case "X":d=d.toString(16).toUpperCase();break}d=/[def]/.test(k[8])&&k[3]&&d>=0?"+"+d:d;l=k[4]?k[4]=="0"?"0":k[4].charAt(1):" ";t=k[6]-String(d).length;l=k[6]?C(l,t):"";f.push(k[5]?d+l:l+d)}}return f.join("")};u.cache={};u.parse=function(p){p=p;for(var a=[],c=[],e=0;p;){if((a=/^[^\x25]+/.exec(p))!==null)c.push(a[0]);else if((a=/^\x25{2}/.exec(p))!==null)c.push("%");else if((a=/^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/.exec(p))!==
null){if(a[2]){e|=1;var d=[],f=a[2],i=[];if((i=/^([a-z_][a-z_\d]*)/i.exec(f))!==null)for(d.push(i[1]);(f=f.substring(i[0].length))!=="";)if((i=/^\.([a-z_][a-z_\d]*)/i.exec(f))!==null)d.push(i[1]);else if((i=/^\[(\d+)\]/.exec(f))!==null)d.push(i[1]);else throw"[sprintf] huh?";else throw"[sprintf] huh?";a[2]=d}else e|=2;if(e===3)throw"[sprintf] mixing positional and named placeholders is not (yet) supported";c.push(a)}else throw"[sprintf] huh?";p=p.substring(a[0].length)}return c};return u}(),vsprintf=
function(b,C){C.unshift(b);return sprintf.apply(null,C)};
(function(b){function C(){this._curInst=null;this._disabledInputs=[];this._inDialog=this._timepickerShowing=false;this._dialogClass="ui-timepicker-dialog";this._mainDivId="ui-timepicker-div";this._inlineClass="ui-timepicker-inline";this._currentClass="ui-timepicker-current";this._dayOverClass="ui-timepicker-days-cell-over";this.regional=[];this.regional[""]={hourText:"Hour",minuteText:"Minute",amPmText:["AM","PM"],closeButtonText:"Done",nowButtonText:"Now",deselectButtonText:"Deselect"};this._defaults=
...
function(d){b.timepicker.selectNow(d)}).end().find(".ui-timepicker-deselect").bind("click",function(d){b.timepicker.deselectTime(d)}).end().find(".ui-timepicker-close").bind("click",function(){b.timepicker._hideTimepicker()}).end()},_generateHTML:function(a){var c,e,d,f,i=this._get(a,"showPeriod")==true,l=this._get(a,"showPeriodLabels")==true,k=this._get(a,"showLeadingZero")==true;e=this._get(a,"showHours")==true;var t=this._get(a,"showMinutes")==true,z=this._get(a,"amPmText"),s=this._get(a,"rows"),
w=0,x=0,B=f=0,o=0,I=0,A=Array(),D=this._get(a,"hours");c=null;var g=0;d=this._get(a,"hourText");var j=this._get(a,"showCloseButton"),v=this._get(a,"closeButtonText"),n=this._get(a,"showNowButton"),h=this._get(a,"nowButtonText"),m=this._get(a,"showDeselectButton"),q=this._get(a,"deselectButtonText"),y=j||n||m;for(c=D.starts;c<=D.ends;c++)A.push(c);c=Math.ceil(A.length/s);if(l){for(g=0;g<A.length;g++)if(A[g]<12)f++;else B++;g=0;w=Math.floor(f/A.length*s);x=Math.floor(B/A.length*s);if(s!=w+x)if(f&&(!B||
!w||x&&f/w>=B/x))w++;else x++;o=Math.min(w,1);I=w+1;c=Math.ceil(Math.max(f/w,B/x))}f='<table class="ui-timepicker-table ui-widget-content ui-corner-all"><tr>';if(e){f+='<td class="ui-timepicker-hours"><div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">'+d+'</div><table class="ui-timepicker">';for(e=1;e<=s;e++){f+="<tr>";if(e==o&&l)f+='<th rowspan="'+w.toString()+'" class="periods" scope="row">'+z[0]+"</th>";if(e==I&&l)f+='<th rowspan="'+x.toString()+'" class="periods" scope="row">'+
z[1]+"</th>";for(d=1;d<=c;d++)if(l&&e<I&&A[g]>=12)f+=this._generateHTMLHourCell(a,undefined,i,k);else{f+=this._generateHTMLHourCell(a,A[g],i,k);g++}f+="</tr>"}f+="</tr></table></td>"}if(t){f+='<td class="ui-timepicker-minutes">';f+=this._generateHTMLMinutes(a);f+="</td>"}f+="</tr>";if(y){i='<tr><td colspan="3"><div class="ui-timepicker-buttonpane ui-widget-content">';if(n)i+='<button type="button" class="ui-timepicker-now ui-state-default ui-corner-all"  data-timepicker-instance-id="#'+a.id.replace(/\\\\/g,
"\\")+'" >'+h+"</button>";if(m)i+='<button type="button" class="ui-timepicker-deselect ui-state-default ui-corner-all"  data-timepicker-instance-id="#'+a.id.replace(/\\\\/g,"\\")+'" >'+q+"</button>";if(j)i+='<button type="button" class="ui-timepicker-close ui-state-default ui-corner-all"  data-timepicker-instance-id="#'+a.id.replace(/\\\\/g,"\\")+'" >'+v+"</button>";f+=i+"</div></td></tr>"}f+="</table>";f+=b.browser.msie&&parseInt(b.browser.version,10)<7&&!a.inline?'<iframe src="javascript:false;" class="ui-timepicker-cover" frameborder="0"></iframe>':
"";return f},_updateMinuteDisplay:function(a){var c=this._generateHTMLMinutes(a);a.tpDiv.find("td.ui-timepicker-minutes").html(c);this._rebindDialogEvents(a)},_generateHTMLMinutes:function(a){var c,e,d="",f=this._get(a,"rows"),i=Array();e=this._get(a,"minutes");var l=null,k=0,t=this._get(a,"showMinutesLeadingZero")==true,z=this._get(a,"onMinuteShow"),s=this._get(a,"minuteText");if(!e.starts)e.starts=0;if(!e.ends)e.ends=59;for(c=e.starts;c<=e.ends;c+=e.interval)i.push(c);l=Math.round(i.length/f+0.49);
if(z&&z.apply(a.input?a.input[0]:null,[a.hours,a.minutes])==false)for(k=0;k<i.length;k+=1){c=i[k];if(z.apply(a.input?a.input[0]:null,[a.hours,c])){a.minutes=c;break}}d+='<div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">'+s+'</div><table class="ui-timepicker">';k=0;for(e=1;e<=f;e++){for(d+="<tr>";k<e*l;){c=i[k];z="";if(c!==undefined)z=c<10&&t?"0"+c.toString():c.toString();d+=this._generateHTMLMinuteCell(a,c,z);k++}d+="</tr>"}d+="</table>";return d},_generateHTMLHourCell:function(a,
...
true})}this._disabledInputs=b.map(this._disabledInputs,function(f){return f==a?null:f});this._disabledInputs[this._disabledInputs.length]=c.attr("id")}},_isDisabledTimepicker:function(a){if(!a)return false;for(var c=0;c<this._disabledInputs.length;c++)if(this._disabledInputs[c]==a)return true;return false},_checkOffset:function(a,c,e){var d=a.tpDiv.outerWidth(),f=a.tpDiv.outerHeight(),i=a.input?a.input.outerWidth():0,l=a.input?a.input.outerHeight():0,k=document.documentElement.clientWidth+b(document).scrollLeft(),
t=document.documentElement.clientHeight+b(document).scrollTop();c.left-=this._get(a,"isRTL")?d-i:0;c.left-=e&&c.left==a.input.offset().left?b(document).scrollLeft():0;c.top-=e&&c.top==a.input.offset().top+l?b(document).scrollTop():0;c.left-=Math.min(c.left,c.left+d>k&&k>d?Math.abs(c.left+d-k):0);c.top-=Math.min(c.top,c.top+f>t&&t>f?Math.abs(f+l):0);return c},_findPos:function(a){for(var c=this._get(this._getInst(a),"isRTL");a&&(a.type=="hidden"||a.nodeType!=1);)a=a[c?"previousSibling":"nextSibling"];
...
d?c=="all"?b.extend({},d.settings):this._get(d,c):null;var f=c||{};if(typeof c=="string"){f={};f[c]=e}if(d){this._curInst==d&&this._hideTimepicker();u(d.settings,f);this._updateTimepicker(d)}},_setTimeTimepicker:function(a,c){if(a=this._getInst(a)){this._setTime(a,c);this._updateTimepicker(a);this._updateAlternate(a,c)}},_setTime:function(a,c,e){var d=a.hours,f=a.minutes;c=this.parseTime(a,c);a.hours=c.hours;a.minutes=c.minutes;if((d!=a.hours||f!=a.minuts)&&!e)a.input.trigger("change");this._updateTimepicker(a);
this._updateSelectedValue(a)},_getCurrentTimeRounded:function(){var a=new Date,c=a.getMinutes();c=Math.round(c/5)*5;a.setMinutes(c);return a},parseTime:function(a,c){var e={};e.hours=-1;e.minutes=-1;var d=this._get(a,"timeSeparator"),f=this._get(a,"amPmText"),i=this._get(a,"showHours"),l=this._get(a,"showMinutes"),k=this._get(a,"optionalMinutes");a=this._get(a,"showPeriod")==true;d=c.indexOf(d);if(d!=-1){e.hours=parseInt(c.substr(0,d),10);e.minutes=parseInt(c.substr(d+1),10)}else if(i&&(!l||k))e.hours=
...
[this[0]].concat(c));return this.each(function(){typeof a=="string"?b.timepicker["_"+a+"Timepicker"].apply(b.timepicker,[this].concat(c)):b.timepicker._attachTimepicker(this,a)})};b.timepicker=new C;b.timepicker.initialized=false;b.timepicker.uuid=(new Date).getTime();b.timepicker.version="0.3.1";window["TP_jQuery_"+p]=b})(jQuery);
