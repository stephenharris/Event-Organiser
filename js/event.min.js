...
b(".reoccurence .event-date :input").toggleClass("ui-state-disabled",y)}b(".eo_occurrence_toogle").click(function(g){g.preventDefault();g.stopPropagation();A.toggle();A.is(":visible")?b(".eo_occurrence_toogle").val(EO_Ajax_Event.locale.hideDates):b(".eo_occurrence_toogle").val(EO_Ajax_Event.locale.showDates)});y=new Date;f(y.getFullYear(),y.getMonth()+1,{});var A=b("#eo_occurrence_datepicker");A.length>0&&A.datepicker({dateFormat:"yy-mm-dd",onSelect:j,beforeShowDay:e,onChangeMonthYear:f,changeMonth:true,
