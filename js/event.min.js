var eo_include_dates,eo_exclude_dates;
...
init:function(a){a=d.extend({},{schedule:"once",frequency:1,schedule_last:new Date,start:new Date,end:new Date,is_all_day:false,dates_by_rule:[]},a);for(var b in a)this[b]=a[b];return this},generate_dates_by_rule:function(a,b){var c=new Date(a,b-1,1);a=new Date(new Date(a,b,1)-1);if(!(this.schedule_last<c||this.start>a))this.dates_by_rule=n(this,c,a)},generate_summary:function(a){var b=a.weekDay,c=a.summary+" ",h={monthNamesShort:a.monthAbbrev,dayNamesMin:a.dayAbbrev,monthNames:a.monthNames},g=this.schedule,
i=new Array("SU","MO","TU","WE","TH","FR","SA");switch(g){case "once":return"This event will be a one-time event";case "custom":case "daily":c+=this.frequency>1?sprintf(a.dayPlural,this.frequency):a.daySingle;break;case "weekly":c+=this.frequency>1?sprintf(a.weekPlural,this.frequency):a.weekSingle;g=d.map(this.schedule_meta,function(l){return b[i.indexOf(l)]});c+=" "+g.join(", ");break;case "monthly":c+=this.frequency>1?sprintf(a.monthPlural,this.frequency):a.monthSingle;if(this.schedule_meta.match(/BYMONTHDAY=(\d+)/))c=
