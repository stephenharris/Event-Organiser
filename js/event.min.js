...
break;case "monthly":m+=i>1?sprintf(n.monthPlural,i):n.monthSingle;if(b("#dayofmonthrepeat :radio:checked").val()=="BYMONTHDAY=")m=m+" "+g.getDate()+a(g);else{i=g.getDay()%7;g=parseInt(Math.floor((g.getDate()-1)/7));m=m+" "+n.occurrence[g]+" "+h[i]}break;case "yearly":m+=i>1?sprintf(n.yearPlural,i):n.yearSingle;m=m+" "+b.datepicker.formatDate("MM d",g,o)+a(g);break}g=b("#recend").datepicker("getDate");if(g!=null)m=m+" "+n.until+" "+b.datepicker.formatDate("MM d'"+a(g)+"' yy",g,o);b("#event_summary").html(m)}}
