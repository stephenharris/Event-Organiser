		...
		if (buttonStr) {
			$.each(buttonStr.split(' '), function(i) {
				...
				$.each(this.split(','), function(j, buttonName) {
					if (buttonName == 'title') {
					...
					}else if(buttonName == 'venue'){
						element = $("<span class='fc-header-dropdown filter-venue'></span>");
						e.append(element);
						build_venue_dropdown(element)
					}else if(buttonName == 'category'){
						element = $("<span class='fc-header-dropdown filter-category'></span>");
						e.append(element);
						...
						if (buttonClick) {
							...
							var button = $(
								"<span class='fc-button fc-button-" + buttonName + " " + tm + "-state-default'>" +text+"</span>"
							);
							button.button();
							if (button) {
								button
