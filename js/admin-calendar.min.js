...
"yyyy-MM-dd"),p=jQuery.fullCalendar.formatDate(e,"HH:mm"),o=jQuery.fullCalendar.formatDate(g,"yyyy-MM-dd"),l=jQuery.fullCalendar.formatDate(g,"HH:mm");if(j){f="ddd, dS MMMM";j=1}else{f="ddd, dS MMMM h(:mm)tt";j=0}if(n==o){e=jQuery.fullCalendar.formatDate(e,f,m);j||(e=e+" &mdash; "+jQuery.fullCalendar.formatDate(g,"h(:mm)tt",m))}else e=jQuery.fullCalendar.formatDate(e,f,m)+" &mdash; "+jQuery.fullCalendar.formatDate(g,f,m);a("#eo_event_create_cal input[name='eo_event[event_title]']").val("");a("#eo_event_create_cal input.ui-autocomplete-input").val("");
